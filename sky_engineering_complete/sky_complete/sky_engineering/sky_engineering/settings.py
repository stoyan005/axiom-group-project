"""
Sky Engineering Portal - Django Settings
...
INSTALLED_APPS = [
    ...
    'accounts',
    'messaging',
    # NOTE for teammates: add your apps here e.g. 'teams', 'organisation', 'schedule', 'reports'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],   # Project-level templates (base.html, navbar, etc.)
...
# SQLite database as required by brief
DATABASES = {
    'default': {
